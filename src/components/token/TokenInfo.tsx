...
export function TokenInfo({ token, graduatedToPancakeSwap: graduatedToPancakeSwapProp }: TokenInfoProps) {
  ...
  const [graduatedToPancakeSwap, setGraduatedToPancakeSwap] = useState(graduatedToPancakeSwapProp || false);
  ...
  return (
    <div className="space-y-6 min-w-0">
      ...
      {token.launchType === "project-raise" && token.projectRaise && !graduatedToPancakeSwap && (
        <Card className="p-4 md:p-6 overflow-hidden">
