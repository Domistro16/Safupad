...
const NETWORKS = {
    bsc: {
        ...
        contracts: {
            launchpadManager: '0x93f526689Ddccd35882b7Ec3C79F40e70fe3014d', // TODO: UPDATE AFTER MAINNET DEPLOYMENT
            ...
            lpFeeHarvester: '0xAd0edb8cf7Cd9BF8ca11Fc8A9593c15a922D8870', // TODO: UPDATE AFTER MAINNET DEPLOYMENT
...
class BaseContract {
    ...
    updateSigner(signer) {
        this.signer = signer;
        this.contract = new ethers.Contract(this.address, this.contract.interface, signer);
    }
    /**
     * Update graph client
     */
    ...
    addEventListener(eventName, callback, filter) {
        ...
        if (filter?.fromBlock || filter?.toBlock) {
            ...
            const eventContract = new ethers.Contract(this.address, this.contract.interface, this.eventQueryProvider);
